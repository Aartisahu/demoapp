    ...
    if (Boolean(isLogin)) {
        return(
          <div>
            ...
            <h2> USER UPDATE PROFILE</h2><br></br>
            <div className= "formborder">
              <form   onSubmit={(event) => this.handleClickUpdate(event)}>
                ...
                NAME:<input  className="name" type="text" pattern="^[a-zA-Z\\s]*$" name="name" value={this.state.name}  required onChange={this.handleChange}/><br></br><br></br>
                PHONE_NUMBER:<input  className="phone" pattern="^\d{10}$" type="Number" name="phone_Number" value={this.state.phone_Number} required  onChange={this.handleChange}/><br></br><br></br>
              ...
              ANSWER: <input  className="answer" type="text" name="security_Answer" value={this.state.security_Answer} required  onChange={this.handleChange}/><br></br><br></br>
            ...
            <center className="center1">
              ...
              <div className= "formborder">
                <form onSubmit={(event) => this.handleClick(event)}>
                  <img  className='circular' src={this.state.file} alt=""/>
                  <ReactFileReader handleFiles={this.handleFiles} base64={true}>
                    Upload_Image Here
                  </ReactFileReader><br></br>
                  NAME:<input className="name" type="text" pattern="^[a-zA-Z\\s]*$" required name="name" value={this.state.name} onChange={this.handleChange}/><br></br><br></br>
                  PHONE_NUMBER:<input  className="phone" type="Number" pattern="^\d{10}$" required name="phone_Number" value={this.state.phone_Number} onChange={this.handleChange}/><br></br><br></br>
